...
class RealCollisionParams(tk.Frame):
    def __init__(self, master=None, on_start=None, on_back=None):
        ...
        self.e_var  = tk.DoubleVar(value=0.5)
    ...
    def _create_widgets(self):
        tk.Label(self, text="Real Collision", font=("Arial", 16, "bold")).grid(row=0, columnspan=2, pady=10)
        ...
        fields = [
            ...
            ("Coefficient of Restitution (0–1):", self.e_var),
        ]
    ...
    def _validate(self):
        ...
        if m1 <= 0 or m2 <= 0:
            ...
            return False
        if not (0 <= e <= 1):
            messagebox.showerror("Invalid Input", "Coefficient of restitution must be between 0 and 1")
            return False
        return True
