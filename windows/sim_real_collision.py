...
from physics.real_collision import RealCollisionPhysics

CY = 300


class RealCollisionSim(tk.Frame):
    def __init__(self, master, shape, v1, v2, s1, s2, m1, m2, e, on_back=None):
        ...
        self.engine = RealCollisionPhysics(
            self.p1, self.p2, v1, v2, s1, s2, m1, m2, e,
