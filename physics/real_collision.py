class RealCollisionPhysics:
    """
    Collision with a coefficient of restitution e.
    e = 1  → perfectly elastic
    e = 0  → perfectly inelastic
    """
    def __init__(self, p1, p2, v1, v2, s1, s2, m1, m2, e,
    ...
    def resolve_impact(self):
        ...
        m1, m2, e  = self.m1, self.m2, self.e
        total_mass = m1 + m2
        self.v1 = (m1 * u1 + m2 * u2 + m2 * e * (u2 - u1)) / total_mass
        self.v2 = (m1 * u1 + m2 * u2 + m1 * e * (u1 - u2)) / total_mass
